...
public class KafkaConsumerService {
    ...
    @KafkaListener(topics = "#{'${spring.kafka.server.topic.transaction.string}'}", groupId= "string_group")
    public void consumeString(String message) {
        log.info("Received String message: {}", message);
    }

    @KafkaListener(topics = "#{'${spring.kafka.server.topic.transaction.transaction}'}", groupId= "transaction_group",
